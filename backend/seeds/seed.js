...
const seedData = async () => {
  ...
  const unhcr = await Organization.create({
    ...
    description:
      "The UN Refugee Agency supporting refugees across East Africa with protection and durable solutions.",
    type: "ngo",
  ...
  const techCorp = await Organization.create({
    ...
    description:
      "Leading technology company committed to inclusive hiring and empowering talent across Africa.",
    type: "employer",
  ...
  const university = await Organization.create({
    ...
    description:
      "Providing quality education and scholarships to refugees and underserved communities.",
    type: "university",
  ...
  const refugees = await User.create([
    {
      ...
      languages: [
        { language: "Somali", proficiency: "native" },
  ...
  await Opportunity.create([
    {
      ...
      description:
        "Join our team as a Community Health Worker to provide essential health services and education to refugee communities in Kakuma and Dadaab camps. You will conduct home visits, facilitate health education sessions, and connect families with medical services.",
      category: "job",
      ...
      requirements: [
        ...
        "Experience in community health or social work",
        "Strong communication skills in Somali or Turkana",
      ...
      coverImage:
        "/images/opportunities/community-health-worker-eastafrica.jpg",
    },
    {
      title: "UNHCR Scholarship Programme 2025",
      description:
        "The UNHCR Scholarship Programme provides full scholarships for refugees to pursue undergraduate and postgraduate studies at partner universities across East Africa. This life-changing opportunity covers tuition, accommodation, and living expenses.",
      ...
      requirements: [
        "UNHCR registered refugee status",
        "Completed secondary education with good grades",
        "Accepted to a partner university",
      ...
      status: "active",
      coverImage: "/images/opportunities/unhcr-scholarship-eastafrica.jpg",
    },
    {
      title: "Junior Software Developer",
      description:
        "TechCorp Africa is seeking talented junior software developers who are passionate about building solutions for Africa. We actively recruit from refugee communities and provide full training and mentorship.",
      category: "job",
      ...
      benefits: [
        "Competitive salary ($500-$800/month)",
        "Remote work options",
        "Mentorship program",
      ...
      status: "active",
      coverImage: "/images/opportunities/junior-developer-eastafrica.jpg",
    },
    {
      title: "Digital Skills Training for Refugees",
      description:
        "A 3-month intensive digital skills training program covering computer literacy, Microsoft Office, internet skills, and basic web design. Designed specifically for refugees with no prior computer experience.",
      category: "training",
      organization: techCorp._id,
      postedBy: employerUser._id,
      location: "Kampala, Uganda",
      ...
      status: "active",
      coverImage: "/images/opportunities/digital-training-eastafrica.jpg",
    },
    {
      title: "Bachelor of Science Scholarship 2025",
      description:
        "East Africa University offers partial scholarships for refugee students pursuing BSc degrees in Science, Technology, Engineering, and Mathematics (STEM) fields. Applications open for the 2025/2026 academic year.",
      category: "scholarship",
      ...
      requirements: [
        ...
        "Completed O-level/KCSE with grade B+ or equivalent",
      ...
      status: "active",
      coverImage: "/images/opportunities/stem-scholarship-eastafrica.jpg",
    },
    {
      title: "Humanitarian Leadership Fellowship",
      description:
        "A 12-month fellowship program for emerging refugee leaders to develop skills in humanitarian response, advocacy, and organizational management. Fellows are placed with leading humanitarian organizations.",
      category: "fellowship",
      organization: unhcr._id,
      postedBy: unhcrUser._id,
      ...
      requirements: [
        ...
        "3+ years in humanitarian or community work",
      ...
      status: "active",
      coverImage:
        "/images/opportunities/humanitarian-fellowship-eastafrica.jpg",
    },
    {
      title: "Entrepreneurship Grant for Refugees",
      description:
        "Launch or scale your business with our micro-grant program. We provide funding of up to $2,000 for refugee entrepreneurs with viable business ideas in agriculture, trade, crafts, or services.",
      ...
      requirements: [
        "Registered refugee or asylum seeker",
        "Viable business plan",
        "Commitment to business development training",
        "Age 18+",
      ],
      benefits: [
        "Grant of $500–$2,000",
      ...
      status: "active",
      coverImage: "/images/opportunities/entrepreneurship-grant-eastafrica.jpg",
    },
    {
      title: "Marketing & Communications Internship",
      description:
        "TechCorp Africa offers a 6-month paid internship for talented individuals to join our marketing team. Learn digital marketing, content creation, and communications strategy in a fast-paced tech environment.",
      category: "internship",
      organization: techCorp._id,
      postedBy: employerUser._id,
      location: "Kampala, Uganda",
      ...
      duration: "6 months",
      status: "active",
      coverImage: "/images/opportunities/marketing-internship-eastafrica.jpg",
    },
    {
      title: "Research Grant in Public Health",
      description:
        "Apply for our competitive research grant to conduct public health research on refugee health challenges. Successful applicants will receive funding, mentorship, and access to research facilities.",
      category: "grant",
      organization: university._id,
      postedBy: uniUser._id,
      location: "East Africa (Multiple Locations)",
      isRemote: false,
      deadline: new Date(Date.now() + 40 * 24 * 60 * 60 * 1000),
      requirements: [
        "Refugee or asylum seeker status",
        "Research proposal in public health",
        "Academic or professional background in health sciences",
        "Commitment to publish findings",
      ],
      benefits: [
        "Grant funding of $5,000–$10,000",
        "Mentorship from senior researchers",
        "Access to university labs and resources",
        "Publication support",
      ],
      tags: ["research", "grant", "public health", "university", "East Africa"],
      fundingAmount: "$5,000–$10,000",
      status: "active",
      coverImage:
        "/images/opportunities/public-health-research-grant-eastafrica.jpg",
    },
  ]);
